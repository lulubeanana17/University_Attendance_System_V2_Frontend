...
function CreateOneStudent(props) {
    ...
    function createStudent() {
        ...
        let config = {
            ...
            url: 'http://127.0.0.1:8000/attendance/api/students/',
            headers: {
    ...
    return (
        <div style={{display: "flex", flexDirection: "column", alignItems: "center"}}>
            ...
            <button onClick={createStudent}><Link to={`/getallstudent/`}>Create student</Link></button>
        </div>
    );
}
